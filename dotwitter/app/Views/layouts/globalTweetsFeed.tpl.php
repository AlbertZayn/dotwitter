                ...
                <div class="tweet-modal-functionality">
                    ...
                    <div class="tweet-footer">
                        ...
                        <div class="tweet-likes">
                            <button class="tweet-likes-btn" <?php echo $tweet['liked'] ? ' liked' : ''; ?>" data-tweet-id="<?php echo $tweet['id']; ?>" data-liked="<?php echo $tweet['liked'] ? '1' : '0'; ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="<?php echo $tweet['liked'] ? 'red' : 'currentColor'; ?>"
