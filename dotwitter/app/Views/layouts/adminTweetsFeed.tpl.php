<?php foreach ($adminTweets as $tweet): ?>
                ...
                <div class="tweet-modal-functionality">
                    ...
                    <div class="tweet-admin-footer">
                        <div class="tweet-comments">
                            ...
                            <span class="tweet-comments-number">n <!-- number of comments --></span>
                        </div>
                        <div class="tweet-retweets">
                            ...
                            <span class="tweet-retweets-number">n <!-- number of retweets --></span>
                        </div>
                        <div class="tweet-likes">
                            ...
                            <span class="tweet-likes-number">n <!-- number of likes --></span>
                        </div>
