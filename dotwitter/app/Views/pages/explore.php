            ...
            <div class="explore-feed-header">
                <form method="POST" action="/tweets-search">
                    <div class="input-group mb-3 explore-header-search">
                        ...
                        <input type="search" name="search_keyword" class="explore-input-search" placeholder="Search tweets" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Search tweets">
                    </div>
                </form>
